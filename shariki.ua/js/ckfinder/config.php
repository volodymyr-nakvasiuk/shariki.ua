...
function CheckAuthentication()
{
	...
	return isset($_COOKIE['info_admin']) && !empty($_COOKIE['info_admin']);
...
$config['plugin_imageresize']['smallThumb'] = '140x105';
$config['plugin_imageresize']['mediumThumb'] = '240x180';
$config['plugin_imageresize']['largeThumb'] = '620x465';
