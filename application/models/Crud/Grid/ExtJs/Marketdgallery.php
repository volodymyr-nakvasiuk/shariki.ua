<?php
class Crud_Grid_ExtJs_Marketdgallery extends ArOn_Crud_Grid_ExtJs_GalleryGrid {

	protected $_idProperty = 'photos_id';
	public $sort = "photos_order";
	public $direction = "ASC";
	
	public $editAction = 'view-marketd-gallery-form';

	public function init() {
		$this->trash = false;
		$this->formClass = 'Crud_Form_ExtJs_Marketdgallery';
		$this->gridTitle = 'Галерея';

		$this->ajaxActionName = 'marketdgallery';
		$this->table = "Db_View_MarketdPhotos";
		$this->fields = array(
			'photos_id' => new ArOn_Crud_Grid_Column_Numeric('Id',null,true,false,'50'),
			'photos_name' => new ArOn_Crud_Grid_Column_Image('Изображение',null,true,false,'100','/uploads/images/market_tov/{photos_parent_id}/small/{photos_name}'),
