<?php
class Crud_Form_ExtJs_Servicesgallery extends ArOn_Crud_Form_ExtJs
{
	protected $modelName = 'Db_View_ServicesPhotos';
	protected $_title = 'Фото';

	public function init ()
	{
		$this->_main_grid = 'services';
		$this->action = '/' . self::$ajaxModuleName . '/Servicesgallery/save/';
		$this->actionName = 'servicesgallery';
		$this->_parent_grid_id = 'tabs-win-services';
		...
		$this->fields = array(
			...
			'photos_name' => new ArOn_Crud_Form_Field_AdminImageUpload('photos_name',UPLOAD_IMAGES_PATH.'/services', '{parent_id}/{sha}', true, 'Изображение', null, '5242880', false, false, 150, true, array('big'=>'620x465','middle'=>'240x180','small'=>'140x105'), false),
	...
	public function saveValidData(){
		$this->_alternative_data['photos_type'] = 'services';
