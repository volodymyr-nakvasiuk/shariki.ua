<?php
class Crud_Form_ExtJs_Newsgallery extends ArOn_Crud_Form_ExtJs
{
	protected $modelName = 'Db_View_NewsPhotos';
	protected $_title = 'Фото';

	public function init ()
	{
		$this->_main_grid = 'news';
		$this->action = '/' . self::$ajaxModuleName . '/Newsgallery/save/';
		$this->actionName = 'newsgallery';
		$this->_parent_grid_id = 'tabs-win-news';
		...
		$this->fields = array(
			...
			'photos_name' => new ArOn_Crud_Form_Field_AdminImageUpload('photos_name',UPLOAD_IMAGES_PATH.'/news', '{parent_id}/{sha}', true, 'Изображение', null, '5242880', false, false, 150, true, array('big'=>'620x465','middle'=>'240x180','small'=>'140x105'), false),
	...
	public function saveValidData(){
		$this->_alternative_data['photos_type'] = 'news';
