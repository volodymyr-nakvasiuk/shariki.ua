...
class ArOn_Zend_Cache_Frontend_Class extends Zend_Cache_Core
{
    /**
     * Available options
     *
    ...
    {
    	//return md5($this->_cachedEntityLabel . '__' . $name . '__' . serialize($parameters) . '__' . serialize($this->_cachedEntity));
        return $this->_cachedEntityLabel . '_' . $name . '__' . md5($name . '__' . serialize($parameters));
    }
