 ...
 */
class ArOn_Crud_Form_Decorator_TooltipLabel extends Zend_Form_Decorator_Abstract {
	/**
	...
	public function __call($method, $args) {
		if ((12 == strlen ( $method )) && ('get' == substr ( $method, 0, 3 )) && (('Prefix' == substr ( $method, - 6 )) || ('Suffix' == substr ( $method, - 6 )))) {
	...
	public function render($content) {
		...
		$field_name = $options ['element_name'];
		$place = $options ['place'];
		...
		if (null !== $tag) {
			...
			if (Zend_Registry::get ( 'app/module' ) == 'admin') {
				$label .= '<sup><a href="/admin/help/add/?form[table_name]=' . $table_name . '&form[place]=' . $place . '&form[field]=' . $field_name . '" onmouseover="showAdminTooltip(this,\'' . $place . '\',\'' . $table_name . '\',\'' . $field_name . '\')" style="color:silver; text-decoration: none;" class="tooltip" title="wait..." module="' . Zend_Registry::get ( 'app/module' ) . '">?</a></sup>';
			} else {
				$label .= '<sup><a href="#" onmouseover="showTooltip(this,\'' . $place . '\',\'' . $table_name . '\',\'' . $field_name . '\')" style="color:silver; text-decoration: none;" class="tooltip" title="wait..." module="' . Zend_Registry::get ( 'app/module' ) . '">?</a></sup>';
			}
