...
class Zend_Form_Element_Checkbox extends Zend_Form_Element_Xhtml
{
    ...
    /**
     * Values that are considered as checked
     * @var array
     */
    protected $_isCheckedValues = array(1,'1',true,'true','on','yes','y','checked');
    ...
    {
        if (in_array($value, $this->getIsCheckedValues(), true)) {
	...
	/**
     * Get values that are considered as checked
     * 
     * @return array
     */
    public function getIsCheckedValues()
    {
        return $this->_isCheckedValues;
    }
